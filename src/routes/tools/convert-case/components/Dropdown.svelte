...
<section class="" bind:this={rootEl}>
	...
	<div class="">
		...
		{#if open}
			<div class="relative w-full">
				<ul
					class="absolute top-full left-0 z-10 mt-2 min-w-full overflow-auto rounded-lg border border-neutral-200 bg-white py-2 shadow-lg dark:border-neutral-800 dark:bg-neutral-950"
					role="menu"
				>
